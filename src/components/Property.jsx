  ...
  return (
    <Link to={`/property/${property.id}`}>
      <article id={property.id} className="card">
        <div className="card-image-container" style={{ backgroundImage: `url(${property.picture_url})` }}>
          {/* <img
        ...
        <div className="card-data-container">
            <p>Score: <span className="bold">{property.review_scores_rating}</span></p>
            <p>Price: <span className="bold">{property.price}</span></p>
        </div>
        <div className="card-host-container">
            {/* <div className="card-host-avatar" style={{ backgroundImage: `url(${property.host_url})` }}></div> */}
            <p className="card-host-name">Host: <span className="bold">{property.host_name}</span></p>
        </div>
