...
function App() {
  ...
  return (
    <>
      <ScrollToTop />
      <Navbar />
      <Sidebar isOpen={modalIsOpen} setIsOpen={setModalIsOpen} />
      <Routes>
        <Route
          path="/"
          element={
        ...
        <Route
          path="/property/:id"
          element={<PropertyDetailPage data={data} setData={setData} />}
        />
        <Route
          path="/add-property"
          element={<CreateProperty data={data} setData={setData} />}
        />
        <Route
          path="/edit-property/:id"
          element={<UpdateProperty data={data} setData={setData} />}
        />
